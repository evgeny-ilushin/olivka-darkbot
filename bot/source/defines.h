 ...
 * turn this option ON. This includes <time.h> in addition
 * to <sys/time.h> and shuts it up.
 */
...
#define VERSION_REPLY VERSION_F
/**
 ...
 * channel.
 */
#define OUTPUT1_COUNT 8
#define OUTPUT1_DELAY 1
#define OUTPUT2_COUNT 12
...
#define	COMPLAIN_REASON	"муфлоны!" // Не надо меня обижать!"
#define	DONT_THINK_SO	"I don't think so."
#define	WHUT		"я тут, пусик"
#define	DONNO_Q		"не гони..."
#define	FLOOD_REASON	"Don't flood!"
#define	DEFAULT_KICK	"ПНХ!"
...
#define BITCH_DEOP_REASON "gimmeops!"
#endif
...
#define	DIE_LEVEL		ROOT_LEVEL
#define	JUMP_LEVEL		ROOT_LEVEL
#define	RAW_LEVEL		ROOT_LEVEL

#define	KICK_LEVEL		ADMIN_LEVEL
#define	INTVAR_LEVEL		ADMIN_LEVEL

#define	OP_LEVEL		USER_LEVEL
#define	TOPIC_LEVEL		USER_LEVEL
#define	VOICE_LEVEL		USER_LEVEL
#define	SPEAK_LEVEL		USER_LEVEL
#define	CMD_LEVEL		USER_LEVEL
...
// <zloy>
#define	DONNO_RDB	"donno"
#define	WHUT_RDB	"whut"
#define	SLEEP_RDB	"sleep"

#define	MALE_NICKS		"dat/males.nk"
#define	FEMALE_NICKS	"dat/females.nk"
#define	KICK_PROTECT_FILE	"dat/kick_protect.ini"

#define MASTER_NICK		"zloy"
#define KICK_REVENGE		"муфлон!"
...
#define	MAX_NICK		64
#define PARSE_NICKNAMES	1
#define ENABLE_VERA		1
#define ENABLE_DICTIONARY	1
#define ENABLE_NETPACK		1
