...
#define	L001(a,b) S("PRIVMSG %s :Den exis vali kodiko, gian na valis grapse: \2/msg %s PASS <palioskodikos> <kainourioskodikos>\2 (epidi auti ine i prota sou fora pou vazi kodiko, xrisimopia '0' san ton palio sou kodiko)\n",a,b)
...
#define	L022(a,b,c) S("PRIVMSG %s :Vrika perissotore apo \37%d\37 dedomena, parakalo perioriste thn anazitisi sas\2:\2 %s\n",a,b,c);
...
#define	L026(a,b,c,d,e,f,g,h,i,j,k,l) S("PRIVMSG %s :Letourgiko %s. Ellinika Exo %ld themata stin lista my, Eime energepioimenos gia: %d day%s, %02d:%02d, Exoun rotithi %ld erotisis,Exoun prosthethi %ld themata, kai exoun aferethi %ld themata. Process time: %1.4lf sec%s\n",a,b,c,d,e,f,g,h,i,j,k,l)
#define	L027(a,b,c,d,e,f,g,h,i,j,k,l) S("PRIVMSG %s :Letourgiko %s. Ellinika Exo % ld themata stin lista my, Eime energepioimenos gia: %d day % s, %02 d:%02 d, Exoun rotithi % ld erotisis, Exoun prosthethi % ld themata, kai exoun aferethi % ld themata.Process time: %1.4lf sec % s \n ",a,b,c,d,e,f,g,h,i,j,k,l)
#define	L028(a,b,c,d,e,f,g,h,i,j,k,l) S("PRIVMSG %s :Letourgiko %s. Ellinika Exo %ld themata stin lista my, Eime energepioimenos gia: %d day%s, %02d:%02d, Exoun rotithi %ld erotisis,Exoun prosthethi %ld themata, kai exoun aferethi %ld themata. Process time: %1.4lf sec%s\n",a,b,c,d,e,f,g,h,i,j,k,l)
...
#define	L047(a,b) S("NOTICE %s :Syntaxi: %cAUTOTOPIC <epikefalida>  (vale \"0\" gia na to apenergopiisis)\n",a,b)
...
#define	L055(a)	S("NOTICE %s :Syntaxi: ADDUSER <#kanali> <*user@*.host> <dinami> <kodikos>. diladi; ADDUSER #darkbot *jason@*.superlink.net 3 tonkodikotou ... xrisimopia #* gia na dosi kapion dinami se ola ta kanalia.\n",a)
...
#define	L077(a,b,c,d,e)	S("PRIVMSG %s :Iparxoun %s %d server%s stin lista ton server. Eime ston server #%d.\n",a,b,c,d,e)
...
#define	L087(a,b,c,d,e) S("PRIVMSG %s :%s %s %s? Se piraza na to xanapis? (Grapse %cHELP gia thn syntaxi tou)\n",a,b,c,d,e)
