...
char BS[STRING_SHORT] = "irc.tula.net";
char CMDCHAR[2] = "!";
char CHAN[STRING_SHORT] = "#party";
char s_Mynick[STRING_SHORT] = "olivka2";
char g_host[STRING_SHORT] = { 0 };
char Mynick[STRING_SHORT] = "olivka";
char sleep_chan[STRING_SHORT] = { 0 };
char VHOST[STRING_SHORT] = "0";
char REALNAME[STRING_SHORT] = "http://zloy.tula.net";
